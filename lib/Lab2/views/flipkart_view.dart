...
void main() {
  runApp(
    const MaterialApp(home: FlipkartView(), debugShowCheckedModeBanner: false),
  );
}

class FlipkartView extends StatefulWidget {
  const FlipkartView({super.key});

  @override
  State<FlipkartView> createState() => _FlipkartViewState();
}

class _FlipkartViewState extends State<FlipkartView> {
          ...
          child: Container(
            ...
            child: TextField(
              decoration: InputDecoration(
                hintText: 'Search Flipkart Products',
            ...
            Container(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  SizedBox(width: 20,),
                  _buildCategoryItem('Grocery', Icons.local_grocery_store_outlined, Colors.blue),
                ],
              ),
            ),
